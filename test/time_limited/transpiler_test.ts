...
describe('Transpiler', function() {
    ...
    describe('#transpile()', () => {
        it('should run isPrime faster than 7 seconds', () => {
            const types = new Map();
            types.set('isPrime', [WebAssemblyType.INT_32]);
            types.set('isPrimeWhile', [WebAssemblyType.INT_32]);

            const wrapper = transpiler.transpile(isPrime.toString() + isPrimeWhile.toString(), types);
        ...
        it('should run fibonacci faster than 7 seconds', () => {
            const types = new Map();
            types.set('fibonacci', [WebAssemblyType.INT_32]);
            types.set('fibonacciWhile', [WebAssemblyType.INT_32]);

            const wrapper = transpiler.transpile(fibonacci.toString() + fibonacciWhile.toString(), types);
        ...
        it('should run gcd faster than 11 seconds', () => {
            const types = new Map();
            types.set('gcd', [WebAssemblyType.INT_32, WebAssemblyType.INT_32]);
            types.set('gcdWhile', [WebAssemblyType.INT_32, WebAssemblyType.INT_32]);

            const wrapper = transpiler.transpile(gcd.toString() + gcdWhile.toString(), types);
        ...
        it('should run sum array faster than 7 seconds', () => {
            const types = new Map();
            types.set('sumArray', [WebAssemblyType.INT_32_ARRAY]);
            types.set('sumArrayFill', [WebAssemblyType.INT_32_ARRAY]);
            types.set('sumArrayFor', [WebAssemblyType.INT_32_ARRAY]);
        ...
        it('should run quicksort faster than 12 seconds', () => {
            const types = new Map();
            types.set('quickSortSwap', [WebAssemblyType.INT_32_ARRAY, WebAssemblyType.INT_32, WebAssemblyType.INT_32]);
            types.set('quickSortPartition', [WebAssemblyType.INT_32_ARRAY,
        ...
        it('should run mergesort faster than 16 seconds', () => {
            const types = new Map();
            types.set('mergeSortCopyArray', [WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32,
                WebAssemblyType.INT_32]);
            types.set('mergeSort', [WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32,
                WebAssemblyType.INT_32]);
            types.set('mergeSortMerge', [WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32_ARRAY,
                WebAssemblyType.INT_32,
                WebAssemblyType.INT_32,
                WebAssemblyType.INT_32]);
            types.set('mergeSortIsSorted', [WebAssemblyType.INT_32_ARRAY]);
            types.set('mergeSortFill', [WebAssemblyType.INT_32_ARRAY]);
            types.set('mergeSortWhile', [WebAssemblyType.INT_32_ARRAY, WebAssemblyType.INT_32_ARRAY]);
