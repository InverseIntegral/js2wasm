...
describe('Transpiler', () => {
    describe('#transpile()', () => {
        ...
        it('should handle if else statements', () => {
            ...
            expect(alwaysOne('alwaysOne')).to.equal(1);
        });
        ...
        it('should handle if statements without else part', () => {
            ...
            expect(alwaysTwo('alwaysTwo')).to.equal(2);
        });
        ...
        it('should handle else if statements', () => {
            ...
            expect(elseIf('elseIf', true, false)).to.equal(0);
            expect(elseIf('elseIf', true, true)).to.equal(0);
            expect(elseIf('elseIf', false, true)).to.equal(1);
            expect(elseIf('elseIf', false, false)).to.equal(2);
        });
        ...
        it('should handle multiple else if statements', () => {
            ...
            expect(elseIf('elseIf', true, true, true)).to.equal(0);
            expect(elseIf('elseIf', true, true, false)).to.equal(0);
            expect(elseIf('elseIf', true, false, true)).to.equal(0);
            expect(elseIf('elseIf', true, false, false)).to.equal(0);
            expect(elseIf('elseIf', false, true, true)).to.equal(1);
            expect(elseIf('elseIf', false, true, false)).to.equal(1);
            expect(elseIf('elseIf', false, false, true)).to.equal(2);
            expect(elseIf('elseIf', false, false, false)).to.equal(3);
        });
        ...
        it('should handle logical operators in if statement', () => {
            ...
            expect(elseIf('elseIf', true, true)).to.equal(0);
            expect(elseIf('elseIf', true, false)).to.equal(1);
            expect(elseIf('elseIf', false, true)).to.equal(1);
            expect(elseIf('elseIf', false, false)).to.equal(2);
        });
        it('should handle if with multiple statements', () => {
            ...
            expect(elseIf('elseIf', true, false, 1)).to.equal(2);
            expect(elseIf('elseIf', false, true, 1)).to.equal(3);
            expect(elseIf('elseIf', false, false, 1)).to.equal(4);
        });
        ...
        it('should handle if statements without braces', () => {
            ...
            expect(ifWithout('ifWithout', true)).to.equal(10);
            expect(ifWithout('ifWithout', false)).to.equal(20);
        });
        ...
        it('should handle else if statements without braces', () => {
            ...
            expect(ifWithout('ifWithout', true, false)).to.equal(10);
            expect(ifWithout('ifWithout', false, true)).to.equal(20);
            expect(ifWithout('ifWithout', false, false)).to.equal(30);
        });
    });
});
