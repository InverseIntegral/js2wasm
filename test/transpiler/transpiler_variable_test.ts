...
describe('Transpiler', () => {
    describe('#transpile()', () => {
        ...
        it('should handle plus shorthand assignment', () => {
            ...
            const {plusAssign} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('plusAssign', 1));
        ...
        it('should handle minus shorthand assignment', () => {
            ...
            const {minusAssign} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('minusAssign', 1));
        ...
        it('should handle multiplication shorthand assignment', () => {
            ...
            const {multAssign} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('multAssign', 1));
        ...
        it('should handle division shorthand assignment', () => {
            ...
            const {divAssign} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('divAssign', 1));
        ...
        it('should handle a single variable', () => {
            ...
            const {variables} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('variables', 1));
            expect(variables(100)).to.equal(10);
        });

        it('should handle a single variable with direct assignment', () => {
            const content = 'function variables() { var x = 10; return x; }';
            const {variables} = Transpiler.transpile(content, createSingleIntegerOnlyFunction('variables', 0));
