...
describe('Transpiler', () => {
    ...
    describe('#transpile()', () => {
        ...
        it('should handle plus shorthand assignment', () => {
            ...
            exports.setCallFunctionName('plusAssign');

            expect(exports.call(5)).to.equal(6);
            expect(exports.call(-5)).to.equal(-4);
        });

        it('should handle minus shorthand assignment', () => {
            const content = 'function minusAssign(a) { var b = 1; b -= a; return b; }';
            const exports = transpiler.transpile(content);
            exports.setCallFunctionName('minusAssign');
        ...
        it('should handle multiplication shorthand assignment', () => {
            ...
            const exports = transpiler.transpile(content);
            exports.setCallFunctionName('multAssign');

            expect(exports.call(5)).to.equal(10);
            expect(exports.call(-5)).to.equal(-10);
        });
        ...
        it('should handle division shorthand assignment', () => {
            ...
            const exports = transpiler.transpile(content);
            exports.setCallFunctionName('divAssign');

            expect(exports.call(5)).to.equal(2);
            expect(exports.call(-5)).to.equal(-2);
        });

        it('should handle a single variable', () => {
            const exports = transpiler.transpile('function variables(a) { var x; x = 10; return x; }');
            expect(exports.setCallFunctionName('variables').call(100)).to.equal(10);
        });
        ...
        it('should handle a single variable with direct assignment', () => {
            ...
            expect(exports.setCallFunctionName('variables').call()).to.equal(10);
        });

        it('should handle multiple variables', () => {
            const content = 'function variables(a) { var x, y; x = 10; y = 20; return x * y; }';
            const exports = transpiler.transpile(content);
            expect(exports.setCallFunctionName('variables').call(100)).to.equal(200);
        });
        ...
        it('should handle variables within branches', () => {
            ...
            const exports = transpiler.transpile(content);
            exports.setCallFunctionName('variables');
        ...
        it('should hoist variable declarations', () => {
            ...
            expect(exports.call(true)).to.equal(20);
            expect(exports.call(false)).to.equal(20);
        });
